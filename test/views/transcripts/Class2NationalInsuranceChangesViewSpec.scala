  ...
  "Class2NationalInsuranceChanges view" must {
    ...
    "have correct content" in {
      ...
      val contentList: List[String] = List(
        ...
        "Once you’ve done this you can recalculate the Class 2 amount. If your profits were less than £6,025 you won’t have to pay Class 2. " +
          ...
          "31 January 2019. The calculation summary screen shows the total tax and National Insurance contributions due and the payments on account.",
