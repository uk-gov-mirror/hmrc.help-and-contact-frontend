...
class HowToPaySelfAssessmentViewSpec extends ViewBehaviours {
  ...
  def createView = () => how_to_pay_self_assessment(frontendAppConfig)(HtmlFormat.empty)(fakeRequest, messages)
  ...
  "HowToPaySelfAssessment view" must {
    ...
    "have viewing your self assessment calculation video transcript link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
    ...
    "have paying your self assessment tax bill video transcript link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
    ...
    "have online or telephone banking list item link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
    ...
    "have debit or credit card list item link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
    ...
    "have bank or building society list item link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
    ...
    "have Direct Debit list item link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
        "direct-debit",
    ...
    "have cheque by post list item link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
        "cheque-by-post",
    ...
    "have budgeting for your self assessment tax bill transcript link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
    ...
    "have reasonable excuses link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
        "reasonable-excuses",
    ...
    "have address for Self Assessment enquiries link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
    ...
    "have self assessment penalties video transcript link" in {
      val doc = asDocument(createView())
      assertLinkById(
        doc,
