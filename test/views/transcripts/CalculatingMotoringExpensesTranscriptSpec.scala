...
class CalculatingMotoringExpensesTranscriptSpec extends ViewBehaviours {
  ...
  "CalculatingMotoringExpensesTranscript view" must {
    ...
    "have correct content" in {
      ...
      h1s.size() mustBe 1
      h1s.first().text() mustBe "Video transcript - What motoring expenses can I claim if I’m self-employed?"
      ...
      val contentList: List[String] = List(
        ...
        "For example, if the total running costs were six thousand pounds, and seventy-five per cent of the miles " +
          "were for business use, you would include four thousand five hundred pounds on your Self Assessment tax return.",
