...
class NewYourFirstTaxReturnSpec extends ViewBehaviours {
  ...
  def createView = () => inject[new_your_first_tax_return].apply(frontendAppConfig)(HtmlFormat.empty)(fakeRequest, messages)
  ...
  "NewIncomeFromProperty view" must {
    ...
    "have correct content" in {
      ...
      val contentList = List(
        ...
        "The tax year ends on the fifth of April and you need to register for Self Assessment by the fifth of October, or you may be charged a penalty. " +
          "You can register on GOV.UK – there’s another short You Tube video that explains how to do this.",
        "Your tax return, which covers the tax year that ended in April, is due by the thirty first" +
          " of January the following year. Once you’ve registered and activated your online account, you’re ready to start.",
