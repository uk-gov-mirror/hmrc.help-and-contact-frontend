...
import views.html.ctax_closing_limited_company
...
class CtaxClosingLimitedCompanyViewSpec extends ViewBehaviours {
  ...
  def createView(): () => HtmlFormat.Appendable =
    () =>  ctax_closing_limited_company.apply()(messages)
  ...
  "Closing a limited company view" must {
    ...
    "contain heading ID" in {
      ...
      doc.getElementsByTag("h1").attr("id") mustBe "ctax-closing-limited-company"
    }
