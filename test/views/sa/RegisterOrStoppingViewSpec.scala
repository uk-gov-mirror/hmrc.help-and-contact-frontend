...
class RegisterOrStoppingViewSpec extends ViewBehaviours {
  ...
  "Self Assessment Expenses view" must {
    ...
    "contain correct heading" in {
      ...
      h1s.size() mustBe 1
      h1s.first().text() mustBe "Registering or stopping"
    }
    ...
    "have correct links" in {
      ...
      assertLinkById(
        ...
        "www.gov.uk/find-lost-utr-number",
      ...
      assertLinkById(
        doc,
        "file-register-sa",
        "register for Self Assessment (opens in new tab).",
        "https://www.tax.service.gov.uk/business-account/add-tax/self-assessment/have-sa-utr",
      ...
      assertLinkById(
        ...
        "https://tax.service.gov.uk/business-account/help/transcript/registering-for-self-assessment",
