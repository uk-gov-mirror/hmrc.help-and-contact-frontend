...
class SelfAssessmentPenaltiesViewSpec extends ViewBehaviours {
  ...
  "BudgetingYourSelfAssessment view" must {
    ...
    "contain heading ID" in {
      ...
      doc.getElementsByTag("h1").attr("id") mustBe "sa-penalties-transcript"
    }
    ...
    "have correct content" in {
      ...
      val contentList = List(
        ...
        "If you do need to send one and we receive your return late you’ll get a penalty of £100 if your tax return is up to 3 months late. These penalties won’t be reduced, even if you have nothing to pay on your return.",
