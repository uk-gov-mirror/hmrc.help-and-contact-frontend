...
class ExpensesIfYouAreSelfEmployedTranscriptSpec extends ViewBehaviours {
  ...
  "ExpensesIfYouAreSelfEmployedTranscript view" must {
    ...
    "have correct content" in {
      ...
      h1s.size() mustBe 1
      h1s.first().text() mustBe "Video transcript – What self-employed expenses can I include in my tax return?"
      ...
      val bulletList = List(
        ...
        "and marketing and subscriptions.",
      ...
      val contentList = List(
        "You’re self-employed – which means you have essential costs to keep your business running. You can deduct these " +
          "costs – called allowable expenses – to work out your taxable profit.",
        ...
        "If your income is at or above the VAT threshold, you’ll need to list each expense individually under the " +
        ...
        "If your income is below the VAT threshold, it’s up to you whether you give us your total amount " +
        ...
        "and in our other helpful videos on YouTube."
      )
