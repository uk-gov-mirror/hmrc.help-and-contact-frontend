  ...
  "YourSelfEmployedTaxReturn view" must {
    ...
    "have correct content" in {
      ...
      val contentList = List(
        ...
        "The first question is about your annual turnover. If you didn’t trade for a full year, " +
          "but if you had and your income would’ve been over £83,000, you answer ‘yes’.",
        "For example: If your business income over 6 months was £50,000, " +
          "then for 12 months it would’ve been £100,000. " +
          "If your trading income is over £83,000 then you may need to register for VAT. " +
          "You’ll also need to give detailed information, such as listing expenses. We’re choosing ‘no’.",
        "Statements appear about your self-employment. Choose those that apply. " +
          "Many people will select ‘None of these apply’. Your business description goes on page 2.",
        "If you started or ceased self-employment during the year, " +
          ...
          "Next takes you to accounting details. Enter your end of year date. " +
        ...
        "If your income is below the VAT threshold, " +
          "just add together all the allowable expenses and enter a single figure, " +
          "or you can enter them separately. The calculations are done automatically. " +
          "‘Next’ takes you to the Capital Allowances page. With cash basis, " +
          "you can only claim capital allowances on business cars. Other tax adjustments are on the next page.",
        "Include the value of any goods or services you’ve had for your own use, " +
        ...
        "Only answer ‘Yes’ if you’re exempt from Class 4 National Insurance contributions.",
        "The few exemptions are listed in the help screen, just use the question mark.",
        "There’s a screen for other information, and then check your entries on this summary page. " +
