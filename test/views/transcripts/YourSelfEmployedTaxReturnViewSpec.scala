    ...
    "have correct content" in {
      ...
      val contentList = List(
        ...
        "The first question is about your annual turnover. If you didn’t trade for a full year, " +
          "but had you, and your income would’ve been over £85,000, you answer “yes”.",
        ...
        "On this page, show your turnover and allowable expenses. This is where you can claim the new £1,000 trading allowance. " +
        ...
        "If you don’t use the trading allowance and your income is below the VAT threshold, " +
          ...
          "You’re then taken to the Capital Allowances page. With cash basis, " +
