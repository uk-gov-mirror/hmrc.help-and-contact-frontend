  ...
  "YourFirstTaxReturn view" must {
    ...
    "have correct content" in {
      ...
      val contentList = List(
        ...
        "The tax year ends on the 5 April, and you need to register for Self Assessment by the 5 October," +
          " or you may be charged a penalty. You can register on GOV.UK – there’s another short You Tube video that explains how to do this.",
        "Your tax return, which covers the tax year that ended in April, is due by the 31 January the following year." +
        ...
        "In the section called Tailor your return you answer yes or no to a series of questions –" +
          " this means you only fill in the sections that apply to you. If you’re not sure about a question, click on the ‘Help about’ link for guidance.",
