  ...
  "NewTailorYourTaxReturn view" must {
    ...
    "have correct content" in {
      ...
      val contentList = List(
        ...
        "Only answer ‘Yes’ to this question if you incorrectly claimed or you were overpaid" +
          " from an HMRC coronavirus support scheme. Use the ‘Help about’ link for more guidance.",
