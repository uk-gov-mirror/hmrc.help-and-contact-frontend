...
import views.html.ctax_ask_utr_corporation_tax
...
class CtaxAskUtrViewSpec extends ViewBehaviours {
  ...
  def createView(): () => HtmlFormat.Appendable =
    () =>  ctax_ask_utr_corporation_tax.apply()(messages)
  ...
  "Ask for a copy of your Corporation Tax UTR view" must {
    ...
    "contain heading ID" in {
      ...
      doc.getElementsByTag("h1").attr("id") mustBe "get-your-corporation-tax-utr"
    }
