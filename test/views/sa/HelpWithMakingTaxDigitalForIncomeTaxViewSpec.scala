  ...
  "SelfAssessmentTaxReturnCheck view" must {
    ...
    "have correct links" in {
      ...
      assertLinkById(
        ...
        "link - click:Help with your Making Tax Digital Income Tax: Send Quarterly Updates",
      ...
      assertLinkById(
        ...
        "link - click:Help with your Making Tax Digital Income Tax: final declaration",
        expectedOpensInNewTab = true
      )
      assertLinkById(
        doc,
        ...
        "link - click:Help with your Making Tax Digital Income Tax: Find out more",
        expectedOpensInNewTab = true
      )
      assertLinkById(
        doc,
        ...
        "link - click:Help with your Making Tax Digital Income Tax: Sign up for MTD Itsa",
        expectedOpensInNewTab = true
      )
      assertLinkById(
        doc,
        ...
        "link - click:Help with your Making Tax Digital Income Tax: Add tax"
      )
      assertLinkById(
        doc,
        ...
        "link - click:Help with your Making Tax Digital Income Tax: Find Compatible Software",
        expectedOpensInNewTab = true
      )
      assertLinkById(
        doc,
        ...
        "link - click:Help with your Making Tax Digital Income Tax: Making Tax Digital More Help",
        expectedOpensInNewTab = true
      )
    }
  }
