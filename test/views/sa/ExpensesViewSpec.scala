  ...
  "Self Assessment Expenses view" must {
    ...
    "have correct links" in {
      ...
      assertLinkById(
        ...
        "https://www.tax.service.gov.uk/business-account/help/transcript/expenses-if-you-are-self-employed",
      ...
      assertLinkById(
        ...
        "https://www.tax.service.gov.uk/business-account/help/transcript/calculating-motoring-expenses",
