  ...
  "ViewingYourCalculation view" must {
    ...
    "have correct content" in {
      ...
      val contentList = List(
        ...
        "You will then see this screen. This shows the amount you’re due to pay for 2016-17. " +
          "It includes Class 4 and Class 2 National Insurance, if any are due.",
        ...
        "For 2016-17, your payment is due by 31 January 2018. You’ll make a second ‘payment on account’ in July 2018. " +
          "But don’t worry, these payments on account will be deducted from the amount you’re due to pay for the 2017-18 tax year on your " +
        ...
        "You can then see exactly how your tax bill has been worked out. It shows your income, your personal allowance, " +
          "the tax due, any class 4 National Insurance, class 2 National Insurance, and the payments that are due on 31 January 2018. You " +
